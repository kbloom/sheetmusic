...
\newcommand{\song}[2]{\includepdf[pages=-,offset=3mm 0,pagecommand={\thispagestyle{musicbook}},addtotoc={1,section,1,#1,#2}]{#2}}

\newcommand{\songref}[1]{\nameref{#1}, page \pageref{#1}}

\makeatletter
\define@key{facingpagesargs}{onepage}{\def\fp@onepage{#1}}
\define@key{facingpagesargs}{twopage}{\def\fp@twopage{#1}}
\DeclareDocumentCommand{\forcefacingpages}{m}{%
   \begingroup
   \setkeys{facingpagesargs}{#1}
   \checkoddpage
   \ifoddpage
   \fp@onepage
   \fp@twopage
...
\chapter{Maqam Nikriz}
\song{Lecha HaShevach}{Lecha_HaShevach.pdf}
...
\begin{itemize}
   ...
   \item \songref{Im_Eshkachech.pdf}
\end{itemize}
...
\song{Rayonai Yachid}{Rayonai_Yachid.pdf}

\chapter{Maqam Nawa}
\song{Yatza Limloch miBeit Surim}{Yatza_Limloch_Mibeit_Surim.pdf}
...
western instruments, I have found that the quarter tones are variable, 
and can be sharpened or flattened depending on the context, but I treat 
the scale as mostly similar to Maqam Nahawand and the western minor scale.
...
\forcefacingpages{
   twopage={\song{Semach Beni B'Chelkecha}{Semach_Beni_BChelkecha.pdf}},
   onepage={\song{Chochmaah Binah Yah Eli}{Chochmah_Binah_Yah_Eli.pdf}}
}
...
\song{Halayla Layla Layla}{Halayla_Layla_Layla.pdf}
...
approixmate it in my sheet music.
...
\chapter{Moroccan Songs}
\song{Aufa Eshkonah}{Aufah_Eshkonah.pdf}
\song{Tishbi Tzuri Levavi}{Tishbi_Tzuri_Levavi.pdf}
\song{Yodu Lecha Rayonai}{Yodu_Lecha_Rayonai.pdf}
...
\song{Nizke l'kol Berachot}{Nizke_lkol_Berachot_David_Menachem.pdf}
...
\forcefacingpages{
   twopage={\song{Hanerot Halalu}{Hanerot_Halalu.pdf}},
   onepage= {\song{L'neri}{Lneri.pdf}}
}
\song{Malki Eshal Mimach}{Malki_Eshal_Mimach.pdf}
...
\song{Im Eshkachech}{Im_Eshkachech.pdf}
...
\chapter{Bar Mitzvah}
In addition to the songs included in this section of the song book, other
traditional songs for a Bar Mitzvah include:
\begin{itemize}
   \item Yoma Tava D'Rabbanan, sung to the melody of \songref{Yehi_Shalom_bCheleinu_Syrian.pdf}.
\end{itemize}

% Two pages. Needs \forcefacingpages when I add another song
\song{Ramach Evarai}{Ramach_Evarai.pdf} 
