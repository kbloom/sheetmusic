...
\song{Ashir La'el Asher Shavat}{Ashir_La'el_Asher_Shavat.pdf}

\chapter{Bakashot for Shabbat}
\song{Ki Eshmerah Shabbat (Turkish)}{Ki_Eshmerah_Shabbat_Turkish.pdf}
\song{Yom Zeh Shiru La'el}{Yom_Zeh_Shiru_La'el.pdf}
...
\song{Yehi Shalom b'Chelenu (Yerushalmi)}{Yehi_Shalom_b'Chelenu.pdf} %TODO(fix name)
